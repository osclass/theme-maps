            ...
            <div id="main">
                <div class="ad_list">
                    <div id="list_head">
                        <div class="inner">
                            <h1>
                                <strong><?php _e('Search results', 'theme_map') ; ?></strong>
                            </h1>
                            <p class="see_by">
                                <?php _e('Sort by', 'theme_map'); ?>:
                                <?php $i = 0 ; ?>
                ...
                <div class="filters">
                    <form action="<?php echo osc_base_url(true); ?>" method="get" onsubmit="return doSearch()">
                        ...
                        <fieldset class="box location">
                            <h3><strong><?php _e('Your search', 'theme_map'); ?></strong></h3>
                        ...
                        <fieldset class="box show_only">
                            ...
                            <h3><strong><?php _e('Show only', 'theme_map') ; ?></strong></h3>
                            <div class="row checkboxes">
                                <ul>
                                    <li>
                                        <input type="checkbox" name="bPic" id="withPicture" value="1" <?php echo (osc_search_has_pic() ? 'checked="checked"' : ''); ?> />
                                        <label for="withPicture"><?php _e('Show only listings with pictures', 'theme_map') ; ?></label>
                                    </li>
                                </ul>
                            </div>
                            <?php } ?>
                            ...
                            <?php  if ( osc_count_categories() ) { ?>
                                <div class="row checkboxes">
                                    <h6><?php _e('Category', 'theme_map') ; ?></h6>
                                    <ul>
                        ...
                        <button type="submit"><?php _e('Apply', 'theme_map') ; ?></button>
                    </form>
                    <?php osc_alert_form() ; ?>
                </div>
            </div>
                ...
                $(function() {
                    ...
                    $( "#sCity" ).autocomplete({
                        ...
                        select: function( event, ui ) {
                            log( ui.item ?
                                "<?php _e('Selected', 'theme_map'); ?>: " + ui.item.value + " aka " + ui.item.id :
                                "<?php _e('Nothing selected, input was', 'theme_map'); ?> " + this.value );
                        }
                    });
                });
