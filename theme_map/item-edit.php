...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="<?php echo str_replace('_', '-', osc_current_user_locale()); ?>">
    ...
    <body>
        ...
        <div class="content add_item">
            <h1><strong><?php _e('Update your listing', 'theme_map'); ?></strong></h1>
            <ul id="error_list"></ul>
                ...
                <fieldset>
                    ...
                    <input type="hidden" name="secret" value="<?php echo osc_item_secret();?>" />
                        <div class="box general_info">
                            ...
                            <div class="row price">
                                <label><?php _e('Price', 'theme_map'); ?></label>
                        ...
                        <div class="box location">
                            ...
                            <div class="row">
                                <label><?php _e('Country', 'theme_map'); ?></label>
                                <?php ItemForm::country_select(); ?>
                            </div>
                            <div class="row">
                                <label><?php _e('Region', 'theme_map'); ?></label>
                                <?php ItemForm::region_text(); ?>
                            </div>
                            <div class="row">
                                <label><?php _e('City', 'theme_map'); ?></label>
                                <?php ItemForm::city_text(); ?>
                            </div>
                            <div class="row">
                                <label><?php _e('City area', 'theme_map'); ?></label>
                                <?php ItemForm::city_area_text(); ?>
                            </div>
                            <div class="row">
                                <label><?php _e('Address', 'theme_map'); ?></label>
                        ...
                        <?php }?>
                    <button class="itemFormButton" type="submit"><?php _e('Update', 'theme_map'); ?></button>
                    <a href="javascript:history.back(-1)" class="go_back"><?php _e('Cancel', 'theme_map'); ?></a>
                </fieldset>
            </form>
        </div>
