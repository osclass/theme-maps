                    ...
                    <?php while(osc_has_items()) { ?>
                            <div class="item" >
                                    ...
                                    <p class="options">
                                        ...
                                        <span>|</span>
                                        <a class="delete" onclick="javascript:return confirm('<?php echo osc_esc_js(__('This action can not be undone. Are you sure you want to continue?', 'theme_map')); ?>')" href="<?php echo osc_item_delete_url();?>" ><?php _e('Delete', 'theme_map'); ?></a>
